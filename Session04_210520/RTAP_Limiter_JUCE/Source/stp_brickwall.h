...
void stp_brickwall_makeUp(stp_brickwall *x, const STP_INPUTVECTOR *in, STP_OUTPUTVECTOR *out, int vectorSize);
...
void stp_brickwall_clip(stp_brickwall *x, const STP_INPUTVECTOR *in, STP_OUTPUTVECTOR *out, int vectorSize);
...
void stp_brickwall_perform(stp_brickwall *x, const STP_INPUTVECTOR *in, STP_OUTPUTVECTOR *out, int vectorSize);
