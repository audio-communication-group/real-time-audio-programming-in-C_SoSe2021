...
{
    dsp_add(rtap_osc6_tilde_perform, 5, x, sp[0]->s_vec, sp[1]->s_vec, sp[2]->s_vec, sp[0]->s_n);
} //new
...
void rtap_osc6_delay_tilde_free(rtap_osc6_tilde *x)
{
...
void rtap_osc6_delay_tilde_setExternTable(rtap_osc6_tilde *x, t_symbol *name)
{
    int length = 0;
...
void rtap_osc6_delay_tilde_setEnvelopeTable(rtap_osc6_tilde *x, t_symbol *name)
{
    int length = 0;
...
void rtap_delay_tilde_setDelayTime(rtap_osc6_tilde *x, float delayTime)
{
...
void rtap_osc6_delay_tilde_noteOn(rtap_osc6_tilde *x, float frequency, float velocity)
{
