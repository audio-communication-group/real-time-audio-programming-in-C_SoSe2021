...
void rtap_osc6_tilde_dsp(rtap_osc6_lowpass_tilde *x, t_signal **sp)
{
...
void rtap_osc6_tilde_free(rtap_osc6_lowpass_tilde *x)
{
    outlet_free(x->out);
    vas_osc_free(x->osc);
...
{
    rtap_osc6_lowpass_tilde *x = (rtap_osc6_lowpass_tilde *)pd_new(rtap_osc6_tilde_class);
...
void rtap_osc6_tilde_noteOn(rtap_osc6_lowpass_tilde *x, float frequency, float velocity)
{
...
void rtap_osc6_tilde_setup(void)
{
      ...
      CLASS_MAINSIGNALIN(rtap_osc6_tilde_class, rtap_osc6_lowpass_tilde, f);
}
